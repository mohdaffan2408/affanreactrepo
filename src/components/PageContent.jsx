  ...
  return (
    <>
      ...
      {/* <div className={classes.overflowHidden}>
        <div className={classes.trustedPartners}>
          <Container>
            <div className={[classes.partners, "text-center"].join(" ")}>
              <h2 className={[classes.h4, "mb-3"].join(" ")}>
                AppOpener is backed by the best 
              </h2>
              <Row>
                <Col>
                  <div className={classes.cLogo}>
                    <img
                      className={classes.cLogo}
                      src={require("../assets/partner/logo4.svg").default}
                      alt="company Logo"
                    />
                  </div>
                </Col>
                <Col>
                  <div className={classes.cLogo}>
                    <img
                      className={classes.cLogo}
                      src={require("../assets/partner/logo2.svg").default}
                      alt="company Logo"
                    />
                  </div>
                </Col>
                <Col>
                  <div className={classes.cLogo}>
                    <img
                      className={classes.cLogo}
                      src={require("../assets/partner/logo5.png").default}
                      alt="company Logo"
                    />
                  </div>
                </Col>
                <Col>
                  <div className={classes.cLogo}>
                    <img
                      className={classes.cLogo}
                      src={require("../assets/partner/logo1.svg").default}
                      alt="company Logo"
                    />
                  </div>
                </Col>
            ...
            <div className={classes.cardInner}>
              <Card className={classes.cards}>
                <Card.Body>
                  <div className={classes.cardIcon}>
                    <img
                      src={require("../assets/icons/Smart-link.png").default}
                      alt="Logo"
                    />
                  </div>
              ...
              <Card className={classes.cards}>
                <Card.Body>
                  ...
                  <Card.Text>
                  CDN linked subdomains to give your brand an edge over others. Bonus - Can take your PR to the next <i>meta</i> level.
                  </Card.Text>
                </Card.Body>
              </Card>{" "}
              <Card className={classes.cards}>
                <Card.Body>
                  <div className={classes.cardIcon}>
                    <img
                      src={require("../assets/icons/Choice.png").default}
                      alt="Logo"
                    />
                  </div>
              ...
              <Card className={classes.cards}>
                <Card.Body>
                  <div className={classes.cardIcon}>
                    <img
                      src={require("../assets/icons/Secure.png").default}
                      alt="Logo"
                    />
                  </div>
              ...
              <Card className={classes.cards}>
                <Card.Body>
                  <div className={classes.cardIcon}>
                    <img
                      src={require("../assets/icons/qr-code.png").default}
                      alt="Logo"
                    />
                  </div>
      ...
      <div className={classes.developerContainer}>
        <Container>
          <Row>
            <Col>
              <div className={classes.sectionHeader}>
                <h2 className="mb-4">Dive in deeper...</h2>
              </div>
            </Col>
          </Row>
            ...
            <Card className={classes.cardBox}>
              <Card.Body>
                <Row>
                  <Col md={5} sm={6} xs={12}>
                    <Card.Title className={classes.head}>
                      <h4> AppOpener Blog</h4>
                    </Card.Title>
                    <Card.Text>
                      <p>
                      Subscribe to our weekly newsletter to recieve updates on trends, tutorials, tips and tricks.
                      </p>
                      <a href="https://blog.appopener.com/" target="_blank" style={{color:"white",textDecoration:"none"}} className={classes.btnStyleOne}>Learn more</a>
                    </Card.Text>
                  </Col>
                  <Col md={7} sm={6} xs={12}>
     ...
     <LanguageCard />
      ...
      <div className={classes.OnboardingContainer}>
        <Container>
          <div className={classes.features,"mt-5"}>
              ...
              <div className={classes.featuresGrid}>
                <Card className={classes.boardingCards}>
                  <Card.Body className={classes.boardingCardsinner}>
                    <div className={classes.cardIcon}>
                      <img
                        src={require("../assets/services/money.png").default}
                        alt="Logo"
                      />
                    </div>
                    <Card.Title className={classes.head}>
                ...
                <Card className={classes.boardingCards}>
                  <Card.Body className={classes.boardingCardsinner}>
                    <div className={classes.cardIcon}>
                      <img
                        src={require("../assets/services/Deal.png").default}
                        alt="Logo"
                      />
                    </div>
                    <Card.Title className={classes.head}>
                ...
                <Card className={classes.boardingCards}>
                  <Card.Body className={classes.boardingCardsinner}>
                    <div className={classes.cardIcon}>
                      <img
                        src={require("../assets/services/service.png").default}
                        alt="Logo"
                      />
                    </div>
                    <Card.Title className={classes.head}>
                ...
                <Card className={classes.boardingCards}>
                  <Card.Body className={classes.boardingCardsinner}>
                    <div className={classes.cardIcon}>
                      <img
                        src={require("../assets/services/Analytics.png").default}
                        alt="Icon"
                      />
                    </div>
                    <Card.Title className={classes.head}>
                ...
                <Card className={classes.boardingCards}>
                  <Card.Body className={classes.boardingCardsinner}>
                    <div className={classes.cardIcon}>
                      <img
                        src={require("../assets/services/Merchandise.png").default}
                        alt="Logo"
                      />
                    </div>
                    <Card.Title className={classes.head}>
                ...
                <Card className={classes.boardingCards}>
                  <Card.Body className={classes.boardingCardsinner}>
                    <div className={classes.cardIcon}>
                      <img
                        src={require("../assets/services/Community.png").default}
                        alt="Icon"
                      />
                    </div>
                    <Card.Title className={classes.head}>
          ...
          <Row>
            <Col md={6} sm={6} xs={12}>
              <div className={classes.sectionHeader}>
                ...
                <h2 className="mb-4">Join our Fleet   
               
                  </h2>
                  <a href="https://pages.razorpay.com/appopener" target="_blank" className="btn btn-warning btn-lg" style={{"margin-top":"5px","margin-left":"15px","margin-bottom":"20px", "box-shadow":"0 0 0 1px #f0ad4e inset, 0 0 0 2px rgba(255,255,255,0.15) inset, 0 8px 0 0 #eea236, 0 8px 0 1px rgba(0,0,0,0.4), 0 8px 8px 1px rgba(0,0,0,0.5)"
}}> <FaDollarSign/> Invest in us </a>
            ...
            <Col md={6} sm={6} xs={12} >
              <div className={classes.securityImg}>
                <img class="d-none d-lg-block" style={{width:"300px"}}
                  src={require("../assets/services/Rocket.png").default}
                  alt="Security"
                />
              </div>
            </Col>
          ...
          <Col>
            <div className={classes.sectionHeader}>
              ...
              <div className={classes.btnGrps}>
                ...
                <a href="https://api.whatsapp.com/send?phone=919205862458&text=Business%20query" target="_blank" className="btn btn-outline-primary" style={{"width":"300px", "borderRadius":"15px"}}><FaWhatsapp/> Get in Touch</a>
              </div>
            </div>
