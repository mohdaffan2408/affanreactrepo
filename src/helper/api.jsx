...
const production = "http://15.206.203.238/";
const development = "http://13.235.242.252/";
const development_domain = "https://apicot.appopener.com/"
const testing = "http://localhost:5000/"
const prod_http_ip = "http://65.2.143.177/"
const prod_ht_private_ip = "https://api.appopener.com/"; // this is configured inside /etc/hosts ubuntu with lb ip
const same_server = "https://appopener.com/api/cld/v1/"; 

let api_url = same_server;
